...
export class LiteratureReviewView extends BaseView {
  ...
  private async handleGenerate(): Promise<void> {
    ...
    try {
      ...
      ztoolkit.log("[Self-AI] 添加综述任务失败:", error);
      new ztoolkit.ProgressWindow("AI Butler", {
        closeOnClick: true,
        closeTime: 5000,
      })
  ...
  private async handleAskFromTables(): Promise<void> {
    ...
    try {
      ...
      ztoolkit.log("[Self-AI] 添加针对性提问任务失败:", error);
      new ztoolkit.ProgressWindow("AI Butler", {
        closeOnClick: true,
        closeTime: 5000,
      })
  ...
  private async handleFillTables(): Promise<void> {
    ...
    try {
      ...
      ztoolkit.log("[Self-AI] 添加填表任务失败:", error);
      new ztoolkit.ProgressWindow("AI Butler", {
        closeOnClick: true,
        closeTime: 5000,
      })
