...
export class VolcanoArkProvider implements ILlmProvider {
        ...
        requestObserver: (xmlhttp: XMLHttpRequest) => {
          xmlhttp.onprogress = (e: any) => {
            ...
            try {
              ...
              ztoolkit.log("[Self-AI] VolcanoArk stream parse error:", err);
            }
          };
        },
      });
  ...
  async chat(
    ...
    try {
          ...
          xmlhttp.onprogress = (e: any) => {
            ...
            if (status >= 400) {
              try {
                ...
                ztoolkit.log("[Self-AI] VolcanoArk HTTP error:", {
                  status,
                  code,
                  msg,
      ...
      ztoolkit.log("[Self-AI] VolcanoArk request error:", {
  ...
  async generateMultiFileSummary(
    ...
    ztoolkit.log(
      `[Self-AI] 准备发送 ${contentParts.length - 1} 个 PDF 附件到火山引擎`,
    );
