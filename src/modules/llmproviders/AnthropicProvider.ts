...
export class AnthropicProvider implements ILlmProvider {
        ...
        requestObserver: (xmlhttp: XMLHttpRequest) => {
          xmlhttp.onprogress = (e: any) => {
            ...
            try {
              ...
              ztoolkit.log("[Self-AI] Anthropic stream parse error:", err);
            }
          };
        },
      });
  ...
  async chat(
    ...
    try {
          ...
          xmlhttp.onprogress = (e: any) => {
            ...
            if (status >= 400) {
              try {
                ...
                ztoolkit.log("[Self-AI] Anthropic HTTP error:", {
                  status,
                  code,
                  msg,
      ...
      ztoolkit.log("[Self-AI] Anthropic request error:", {
  ...
  async generateMultiFileSummary(
    ...
    ztoolkit.log(
      `[Self-AI] 准备发送 ${documentParts.length} 个 PDF 附件到 Anthropic`,
    );
        ...
        requestObserver: (xmlhttp: XMLHttpRequest) => {
          xmlhttp.onprogress = (e: any) => {
            ...
            try {
                    ...
                    if (json.type === "content_block_delta") {
                      ...
                      if (text) {
                        ...
                        if (onProgress && current.length > delivered) {
                          ...
                          Promise.resolve(onProgress(newChunk)).catch((err) => {
                            ztoolkit.log(
                              "[Self-AI] onProgress error (Anthropic multi-PDF):",
                              err,
                            );
                          });
                        }
              ...
              ztoolkit.log(
                "[Self-AI] Anthropic multi-PDF stream parse error:",
                err,
              );
            }
          };
