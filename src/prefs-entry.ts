 ...
 * This script runs inside the Zotero preferences pane window for Self-AI.
...
(function () {
  try {
    ...
    if (hooks && typeof hooks.onPrefsEvent === "function") {
      ...
      console.warn("[Self-AI][Prefs] hooks.onPrefsEvent not available");
    }
  } catch (e) {
    console.error("[Self-AI][Prefs] prefs-entry execution error:", e);
  }
})();
